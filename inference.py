...
if __name__ == '__main__':
    ...
    parser.add_argument('-w', "--weight", default='/mnt/fast/nobackup/scratch4weeks/tb0035/projects/diffsteg/controlnet/VQ4_s100_mir100k2/checkpoints/final.ckpt', help="Path to checkpoint file.")
    parser.add_argument(
